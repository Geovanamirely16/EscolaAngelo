...
print("o numero maior entre 7 e 9 é: ", maior(7, 9))
print("o numero maior entre 13 e 11 é: ", maior(13, 11))
...
print("o numero 9 é multiplo de 3?: ", multiplo(9, 3))
print("o numero 9 é multiplo de 2?: ", multiplo(9, 2))
...
print(f"Area do quadrado de lado 5: {area(5):.2f}")
print(f"Area do quadrado de lado 3,7: {area(3.7):.2f}")
...
print(f"A area do triangulo de base 3 e altura 5 é {areaTriangulo(3, 5):.2f}") 
print(f"A area do triangulo de base 4.2 e altura 5.5 é {areaTriangulo(4.2, 5.5):.2f}") 
